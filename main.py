...
def start_timer():
    ...
    if reps % 8 == 0:
        ...
        my_label1.config(text="Break", fg=RED)
    # If it's the 2nd/4th/6th rep:
    elif reps % 2 == 0:
        count_down(short_break_sec)
        my_label1.config(text="Break", fg=PINK)
    # If it's the 1st/3rd/5th/7th rep:
    else:
        count_down(work_sec)
        my_label1.config(text="Work", fg=GREEN)
...
my_label1 = Label(text="Timer", font=(FONT_NAME, 44, "bold"), fg=GREEN, bg=YELLOW)
my_label1.grid(row=0, column=1)
my_label2 = Label(fg=GREEN, bg=YELLOW)
